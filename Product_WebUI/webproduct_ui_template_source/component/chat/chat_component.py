...
```python
    ...
    chat = ChatComponent(
        ...
        data_input_mode='textarea',  # 使用textarea输入
...
```
    ...
    def __init__(
        ...
        data_input_mode: Literal['selector', 'textarea'] = 'selector',
        ...
        Args:
            ...
            data_input_mode: 数据输入模式,'selector'(层级选择器)或'textarea'(文本输入框)
    ...
    def render(self):
        ...
        self.chat_sidebar_manager = ChatSidebarManager(
            ...
            data_input_mode=self.data_input_mode  # 传递数据输入模式
        )
