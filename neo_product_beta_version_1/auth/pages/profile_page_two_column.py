...
def profile_page_content():
    ...
    # 主要内容区域 - 4个卡片水平排列 (Optimized for responsiveness and dark mode)
        ...
        with ui.column().classes('w-full p-4 gap-3 h-full'):
            ...
            with ui.card().classes('w-full p-3 bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 rounded'):
                with ui.row().classes('items-center gap-2 w-full'):
                    ...
                    ).classes('bg-orange-600 hover:bg-orange-700 text-white px-2 py-1 text-xs rounded').props('size=sm')

            # 会话管理
            with ui.card().classes('w-full p-3 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded'):
                with ui.row().classes('items-center gap-2 w-full'):
                    ui.icon('devices').classes('text-lg text-blue-600 dark:text-blue-400')
                    with ui.column().classes('flex-1 gap-0'):
                        ui.label('会话管理').classes('text-sm font-bold text-blue-800 dark:text-blue-200')
                        ui.label('管理登录会话和设备').classes('text-xs text-blue-600 dark:text-blue-300')

                    ui.button(
                        '查看',
                        icon='visibility',
                        on_click=lambda: ui.notify('会话管理功能即将推出', type='info')
                    ).classes('bg-blue-600 hover:bg-blue-700 text-white px-2 py-1 text-xs rounded').props('size=sm')
            ...
            with ui.card().classes('w-full p-3 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded mt-auto'):
                with ui.row().classes('items-center gap-2 w-full'):
                    ...
                    ).classes('bg-red-600 hover:bg-red-700 text-white px-2 py-1 text-xs rounded').props('size=sm')