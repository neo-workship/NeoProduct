    ...
    def simple_main_page():
        ...
        @with_simple_spa_layout(
            ...
            nav_items=[
                ...
                {'key': 'enterprise_archive', 'label': '页面1', 'icon': 'business', 'route': 'enterprise_archive'},
                {'key': 'person_archive', 'label': '页面2', 'icon': 'people', 'route': 'person_archive','separator_after': True},
